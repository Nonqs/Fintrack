...
export default function ShowExpenses() {
    ...
    const handleSave = async (index: number) => {
        ...
        const actualName = expensesType[index].name
        ...
        expensesType[index].name = editName
        setEditIndex(-1)
    }

    const handleDelete = async (index: number) => {

        const name = expensesType[index].name
    ...
    return (
        <Card className="w-full h-full">
            <CardHeader className="pb-0 pt-2 px-4 flex-col items-start">
                <h4 className="font-bold text-large">Expenses Types</h4>
            </CardHeader>
            <CardBody>
                {expensesType.map((expense, index) => (
                        ...
                        <div className="w-full flex justify-between">
                            ...
                            <article>
                                {editIndex === index
                                    ...
                                    : (
                                        <article className="flex">
                                            <Button onClick={() => { handleEdit(index), setEditName(expense.name) }} size="sm" className="bg-yellow-400 me-2" isIconOnly color="warning" variant="faded" aria-label="Edit">
