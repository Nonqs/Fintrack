...
const accounts = [
    { icon: "a", name: "bank", balance: 2000 },
    { icon: "a", name: "Cash", balance: 3450 },
    { icon: "a", name: "Mayita", balance: 7000000 }
]
                                ...
                                {editIndex === index
                                    ...
                                    : (
                                        <article className="flex">
                                            ...
                                            <Button size="sm" className="bg-red-400" isIconOnly color="danger" variant="faded" aria-label="Take a photo">
